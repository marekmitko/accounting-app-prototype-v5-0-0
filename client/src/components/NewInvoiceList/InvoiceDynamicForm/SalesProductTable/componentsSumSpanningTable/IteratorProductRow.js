...
const IteratorProductRow = (props) => {
                    ...
                    {({ getSource, scopedFormData, }) => {
                        return (
                            ...
                            {/* <TableRow> */}
                                ...
                                <BoxItemNumberInput flex={5} label="Ilość" source={getSource("item_qty")} resource="products"/>
                                <BoxItemNumberInput flex={2} label="Netto" source={getSource("item_qty")} resource="products"/>
                                <BoxItemNumberInput flex={5} label="VAT" source={getSource("item_vat")} resource="products"/>
                                <BoxItemNumberInput flex={5} label="Ilość" source={getSource("sum_netto")} resource="products"/>
...
export default IteratorProductRow;